 ...
 */
public record WayangCliOutputTarget(String path, boolean force) {
    ...
    public static WayangCliOutputTarget of(String path, boolean force) {
    ...
    public void ensureSupported(boolean supported, String message) {
        if (hasPath() && !supported) {
            throw new IllegalArgumentException(message);
        }
    }

    public void writeOrPrint(
            PrintStream out,
            Writer writer,
            String label,
            String text) {
