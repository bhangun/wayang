...
public class CamelIntegrationTester {
        ...
        try {
            ...
            NodeExecutionTask task = createTask(
                    ...
                    Map.of(
                            ...
                            "targetEndpoints",
                            Arrays.asList("direct:saga-step1", "direct:saga-step2", "direct:saga-step3"),
                            "compensationEndpoints",
                            Arrays.asList("direct:saga-compensate1", "direct:saga-compensate2"),
                            "sagaTimeout", 300L,
                            "tenantId", TEST_TENANT_ID));
    ...
    private NodeExecutionTask createTask(String patternType, Map<String, Object> context) {
        ...
        return new NodeExecutionTask(
                ...
                NodeId.of(TEST_NODE_PREFIX + patternType.toLowerCase().replace("_", "-") + "-"
