...
public final class KnowledgeVerifiedResponseEnvelopeFactory {

    private final KnowledgeVerifiedResponseFingerprinter
            fingerprinter;

    public KnowledgeVerifiedResponseEnvelopeFactory() {
        this(
    ...
    public KnowledgeVerifiedResponseEnvelopeFactory(
            KnowledgeVerifiedResponseFingerprinter fingerprinter) {

        this.fingerprinter = fingerprinter;
    }

    public KnowledgeVerifiedResponseEnvelope create(
            KnowledgeVerifiedResponse response,
            String runtimeId,
            Instant expiresAt) {

        return new KnowledgeVerifiedResponseEnvelope(
                ...
                fingerprinter.fingerprint(response),
                response,
                Instant.now(),
                expiresAt,
                java.util.Map.of()
