...
public final class DefaultKnowledgeVerifiedAnswerArtifactService
        implements KnowledgeVerifiedAnswerArtifactService {

    private final KnowledgeVerifiedAnswerArtifactFactory factory;
    private final KnowledgeVerifiedAnswerArtifactStore store;

    public DefaultKnowledgeVerifiedAnswerArtifactService() {

        this(
                new KnowledgeVerifiedAnswerArtifactFactory(),
                new InMemoryKnowledgeVerifiedAnswerArtifactStore()
        );
    }

    public DefaultKnowledgeVerifiedAnswerArtifactService(
            KnowledgeVerifiedAnswerArtifactFactory factory,
    ...
    @Override
    public KnowledgeVerifiedAnswerArtifact createAndStore(
