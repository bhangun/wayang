...
public final class
DefaultKnowledgeAnswerResolutionDependencyService
        implements KnowledgeAnswerResolutionDependencyService {

    private final KnowledgeAnswerResolutionDependencyGraph graph;

    public DefaultKnowledgeAnswerResolutionDependencyService(
    ...
    public void register(
        ...
        for (var dependency : dependencies) {
            ...
            if (!resolutionKeyFingerprint.equals(
                    dependency.resolutionKeyFingerprint())) {

                throw new IllegalArgumentException(
                        "Dependency belongs to another resolution"
                );
            }
