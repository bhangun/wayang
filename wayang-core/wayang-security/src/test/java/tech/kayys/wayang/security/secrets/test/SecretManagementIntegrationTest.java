...
public class SecretManagementIntegrationTest {
    ...
    void testStoreAndRetrieveSecret() {
        ...
        Secret secret = secretManager.retrieve(
            RetrieveSecretRequest.latest(TEST_TENANT, TEST_SECRET_PATH)
        ).await().indefinitely();
    ...
    void testSecretRotation() {
        ...
        Secret secret = secretManager.retrieve(
            RetrieveSecretRequest.latest(TEST_TENANT, "rotation-test")
        ).await().indefinitely();
    ...
    void testSecretExpiration() {
        ...
        assertThrows(SecretException.class, () ->
            secretManager.retrieve(
                RetrieveSecretRequest.latest(TEST_TENANT, "expiring-secret")
            ).await().indefinitely()
        );
    }
